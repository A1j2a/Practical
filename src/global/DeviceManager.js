...
export default class DeviceManager {
    ...
    static buildVersion = DeviceInfo.getBuildNumber();

    //getBundleId
    static bundleId = DeviceInfo.getBundleId();

    static batteryLevel =  DeviceInfo.getBatteryLevel();

    static diskSpace =  DeviceInfo.getTotalDiskCapacity();
